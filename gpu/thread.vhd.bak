...
begin
	...
	load_store : lsu port map(clk, reset, en, state, mem_read_en, mem_write_en, reg_rs_out, reg_rt_out, mem_read_ready, mem_write_ready, mem_read_data, mem_read_add, mem_write_add, mem_write_data, lsu_out, lsu_state);
end arch;